  ...
  if (type === "profileEdit") {
    return (
      <MenuIcon onClick={_onClick} {...styles} viewBox="0 0 21 21" fill="none">
        <rect width="21" height="21" rx="10.5" fill="#43CA3B"/>
        <path 
        ...
        <path 
          d="M10.4998 13.3269C12.061 13.3269 13.3267 12.0613 13.3267 10.5C13.3267 8.93875 12.061 7.6731 10.4998 7.6731C8.93851 7.6731 7.67285 8.93875 7.67285 10.5C7.67285 12.0613 8.93851 13.3269 10.4998 13.3269Z" 
          fill="#43CA3B" 
          stroke="#959595" 
          strokeLinecap="round" 
          strokeLinejoin="round"/>
...
const Like = styled.svg`
  fill: ${(props) => (props.fill ? `${props.fill}` : `#c4c4c4`)};
  width: ${(props) => `${props.width}`};
  max-width: ${(props) => `${props.maxWidth}`};
  height: ${(props) => `${props.height}`};
  max-height: ${(props) => `${props.maxHeight}`};
