  ...
  if (type === "searchIcon") {
    return (
      <MenuIcon {...styles} viewBox="0 0 37 37" fill="none">
        <path d="M23.3 23.3L31.7001 31.7" stroke="#B5B5B5" strokeWidth="2.5" stroke-linecap="round" stroke-linejoin="round"/>
        <ellipse cx="16.3001" cy="16.3" rx="9.8" ry="9.8" transform="rotate(90 16.3001 16.3)" stroke="#B5B5B5" strokeWidth="2.5"/>
      </MenuIcon>
    );
  }
