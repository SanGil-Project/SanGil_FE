  ...
  if (type === "nameEdit") {
    return (
      <MenuIcon {...styles} viewBox="0 0 17 16" fill="none">
        <path d="M1 15.5H6L16 5.5L11 0.5L1 10.5L1 15.5Z" stroke="#6F6F6F" strokeLinecap="round" strokeLinejoin="round"/>
  ...
  if (type === "searchIcon") {
    return (
      <MenuIcon {...styles} viewBox="0 0 37 37" fill="none">
        <path d="M23.3 23.3L31.7001 31.7" stroke="#B5B5B5" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
