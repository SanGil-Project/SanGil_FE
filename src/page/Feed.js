...
import { Grid, Image, Text, Icon, Input } from "../elements/element";
      ...
      <Desktop>
        <FeedContainer>
          ...
          <Grid overflowY="scroll" height="1080px">
            <Grid height="50px" margin="82px 0 0 0">
              <Grid maxWidth="86%" margin="0 auto" isFlex>
                <Grid maxWidth="204px" isFlex>
                  <Image
                    width="25px"
                    height="25px"
            ...
            <Grid height="20px" margin="10px auto" maxWidth="86%" isFlex>
              <Grid lineHeight="20px" maxWidth="55px" isFlex>
                <Icon type="like" width="18px" height="18px" fill="green" />
